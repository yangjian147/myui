//创建窗体对话框
var $windowDialogDom = $('<div id="windowDialog" class="modal fade bs-example-modal-sm" data-backdrop="static" data-keyboard="false"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button class="close" data-dismiss="modal">&times;</button><h5 class="modal-title">模块提示</h5></div><div class="modal-body"></div></div></div></div>');
